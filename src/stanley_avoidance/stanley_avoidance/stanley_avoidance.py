...
class StanleyAvoidance(Node):
    def __init__(self):
        ...
        self.declare_parameter("max_lookahead_speed", 1.0)
        ...
        self.waypoints_world_path = raceline_path #str(self.get_parameter("waypoints_path").value)
        self.waypoints_world_path_2nd = raceline_path #str(self.get_parameter("waypoints_path_2nd").value)
...
class WaypointUtils:
    def __init__(
        ...
        filepath=raceline_path,
        min_lookahead=0.5,
        max_lookahead=3.0,
        min_lookahead_speed=3.0,
        max_lookahead_speed=6.0,
        filepath_2nd=raceline_path,
        lane_number=0,
    ):
    ...
    def load_and_interpolate_waypoints(self, file_path, interpolation_distance=0.05):
        ...
        points = np.genfromtxt(file_path, delimiter=";")[:, 1:3]
        velocities = np.genfromtxt(file_path, delimiter=";")[:, 5]
