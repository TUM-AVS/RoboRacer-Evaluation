...
class PurePursuitController(Node):
    def __init__(self):
        ...
        # Parameters
        self.wheel_base = 0.335 # the wheel base of the vehicle necessary for the calculation in meters
    ...
    def calculate_control_commands(self):
        ...
        if self.current_pose and self.waypoints.any():
            ...
            # ackermann_cmd.drive.speed = ackermann_cmd.drive.speed * (1 - 0.5 * abs(ackermann_cmd.drive.steering_angle / self.max_steering_angle)) # you can uncommet this is you want to slow down proportioanl to the steering angle
