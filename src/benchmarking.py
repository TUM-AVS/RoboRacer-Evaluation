...
# Paths to define
results_path = 'benchmark_results/stanley_avoidance_02_results.csv' # Path to where the metrics per lap should be saved as csv
data_path = 'data/stanley_avoidance_02.csv' # Path to the pandas dataframe saved as csv with .csv ending
raceline_path = 'Maps_Racelines/FTM_Halle_Large_Track/FTM_Halle_original_high_res.csv' # Path to the raceline with .csv ending
map_path = 'Maps_Racelines/FTM_Halle_Large_Track/FTM_Halle_cleaned_high_res' #without ending
